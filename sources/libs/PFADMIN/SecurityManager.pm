...
# ******************************************************************************************
package PFADMIN::SecurityManager;
...
sub identify {
	...
	if($sid) {
		...
		$mgr->{wstk}->sdb_put($skey => $self->{json}->encode($session)); 
